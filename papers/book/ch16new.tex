...
Under the original thesis, this was about cooperation and commitment. Under the revised thesis, it is about something different: \textbf{the freedom to leave a resource point}. The pattern is the same four Putnam trends. The mechanism has changed entirely --- from ``refusing to cooperate'' to ``refusing to stay at the well.''
