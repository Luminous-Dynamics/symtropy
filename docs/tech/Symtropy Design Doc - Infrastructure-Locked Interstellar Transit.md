---
title: Infrastructure-Locked Interstellar Transit — Legacy Design
version: 0.1
status: superseded
scope: historical interstellar gate concept
owner: design/interstellar
superseded_by: INFRASTRUCTURE_LOCKED_INTERSTELLAR_TRANSIT_GATE_AUTHORITY_AND_FAILURE_RUNTIME_V0_1.md
---

# Symtropy Design Doc: Infrastructure-Locked Interstellar Transit

> **Superseded:** The current authority, commit, uniqueness, quarantine, persistence, and horizon-scope contract is [Infrastructure-Locked Interstellar Transit, Gate Authority, and Failure Runtime](./INFRASTRUCTURE_LOCKED_INTERSTELLAR_TRANSIT_GATE_AUTHORITY_AND_FAILURE_RUNTIME_V0_1.md). This document remains for design provenance.
