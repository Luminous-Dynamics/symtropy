...
scope: representative Seedworks build sequence, integration gates, evidence requirements,
  and cut boundaries
...
- IRIS_UNFLINCHING_REALITY_AND_EXPLOITATION_SAFETY_BENCHMARK_V0_1.md
- V1_8_PLAYABLE_HISTORY_CAMPAIGN.md
- V2_0_IRIS_MACHINE_INTIMACY_AND_UNFLINCHING_HUMAN_REALITY_CAMPAIGN.md
superseded_by: GAME_IMPLEMENTATION_ROADMAP_V1_4.md
---
...
# Playable History Proof Track

This track converts the historical-texture program into one production-bounded playable region. It remains subordinate to the representative Seedworks causal spine.

## P0 — Packet and Identity Harness

Deliver the campaign packet schema, stable IDs, content hashes, worldline ancestry, validation profile, and deterministic minimal loader.
...
- last validated packet remains available after failure.

## P1 — Campaign State Harness

Deliver multidimensional pressures, faction initiatives, commitments, threshold events, event journal, save/load, and LOD transitions.

Exit:

- factions act without player prompting;
- actions require knowledge, authority, capability, route, and resources;
- replay is deterministic;
- named people and unique assets survive LOD round trips.

## P2 — Nine Pumps Regional Fixture

Deliver one utility, two communities, eight named inhabitants, one diaspora route, one informal service network, ordinary-life schedules, drought, maintenance debt, and three successor outcomes.

Exit:

- service continuity is physical;
- workers, customers, creditors, and informal providers remain distinct;
- no outcome maximizes all values;
- the region remains inhabitable after failure.

## P3 — Discoverable History Fixture

Deliver twelve traces across physical ruin, maintenance records, testimony, machine witness, damaged ledger, memorial, and private archive.

Exit:

- discovery follows access and observation;
- interpretations remain evidence-bounded;
- private information does not become public;
- NPCs may discover and publish independently.

## P4 — Ordinary Life and Cultural Season

Deliver meals, shifts, care, apprenticeships, a maintenance festival, public art, cleanup, and post-event memory.

Exit:

- culture requires materials and labor;
- NPCs participate or refuse independently;
- the event remains meaningful outside rewards;
- accessibility is integrated.

## P5 — Revisit and Absence

Run baseline, pressure, partial repair, institutional outcomes, managed failure, six-month absence, five-year absence, and one worldline fork.

Exit:

- physical and social differences are recognizable without a summary screen;
- absence does not freeze the region;
- unique entities do not duplicate;
- public beliefs follow transmission.

## P6 — Production Cut Pass

Remove cinematics, rare permutations, optional interiors, and secondary history while preserving the causal spine and ordinary-life minimum.

Exit:

- content fits declared budget;
- player comprehension and emotional distinctiveness survive cuts;
- deterministic fallback remains complete.

## P7 — Playable History Regional Benchmark

Run `PLAYABLE_HISTORY_REGIONAL_BENCHMARK_V0_1.md` only after independent evidence exists for P0–P6.

## Playable History Cut Rule

If a campaign cannot make one region more physically, socially, and emotionally distinctive under ordinary play, failure, absence, and revisit, it is not ready to multiply.

No v1.8 work may delay embodied movement, local transactions, NPC routines, persistence, or the representative Seedworks build.


# Lore De-Polishing and Local Specificity Proof Track

This track applies to the one-region playable-history proof. It does not authorize galaxy-scale lore expansion.

## T0 — Naming Register Fixture

Deliver stable entity IDs with legal names, endonyms, exonyms, slang, old names, users, and origins.

Exit:

- display-name changes do not alter identity;
- at least 70% of flagship entities have two grounded alternate names;
- poetic names identify an in-world naming source;
- local NPCs use different registers by context.

## T1 — Ordinary Artifact Pack

Deliver at least ten artifacts across bills, menus, schoolwork, jokes, graffiti, obituaries, advertisements, repair logs, family messages, and low-prestige media.

Exit:

- one artifact is boring;
- one is wrong;
- one is affectionate;
- one is unrelated to the main campaign;
- none exists solely to summarize lore.

## T2 — Human Motive and Institutional Asymmetry

Add status, rivalry, family, faith, boredom, fashion, and miscalculation to grounded NPC and institution state.

Exit:

- better evidence does not automatically resolve all conflicts;
- motives cannot invent authority or resources;
- one institution is genuinely competent and loved;
- one institution persists through inertia or ordinary political connection.

## T3 — Popular Culture and Cross-Contamination

Deliver one sport, children's media reference, cheap food chain, celebrity or public personality, bad drama, mascot, fashion cycle, and mixed-household or minority institution.

Exit:

- popular culture has sincere fans;
- at least one unrelated institution affects the major campaign;
- residents may ignore or mock the settlement's signature philosophy;
- culture transmits through real media, people, and goods.

## T4 — Historical Noise and Figure Boundaries

Add disputed chronology, false lessons, administrative residue, quiet consequences, and private-life boundaries.

Exit:

- correction preserves previous records;
- one famous event remains unresolved;
- public precedent does not expose a private person;
- no figure is reduced to one symbolic role.

## T5 — Nonhuman Ordinary-Life Fixture

Deliver maintenance, play-like behavior, internal disagreement, status, care, error, protected space, and one behavior unrelated to humans.

Exit:

- translation confidence remains explicit;
- nonhuman agency is not one harmonious opinion;
- ordinary life exists before formal diplomacy;
- anthropomorphic labels are hypotheses rather than truth.

## T6 — Blind Tone Benchmark

Run `LORE_TONE_VARIANCE_HUMAN_MESS_AND_LOCAL_SPECIFICITY_BENCHMARK_V0_1.md` on held-out excerpts.

Exit:

- no hard failures;
- material specificity, ordinary life, and voice variance meet threshold;
- no single rhetorical template dominates the sample;
- proper-noun masking does not erase regional identity.

## T7 — Production Cut Pass

Remove low-value names, artifacts, celebrities, and variants that increase authoring or localization burden without improving place recognition or lived consequence.

Exit:

- the region remains distinctive under budget;
- essential artifacts survive localization;
- accessibility alternatives exist;
- no v1.9 content delays embodied movement, transactions, NPC routine, persistence, or Nine Pumps causal proof.

## v1.9 Cut Rule

If an addition makes the lore more clever but does not make one inhabited place more recognizable, ordinary, contradictory, or emotionally specific in play, cut it.

# v2.0 IRIS and Unflinching-Reality Proof Track

## U0 — Deterministic IRIS Core

Implement fact provenance, knowledge frontier, advice envelopes, authored emergency phrases, authority warnings, and safe fallback.

Exit:

- no unsupported authoritative claims;
- no required generative service;
- player can inspect why advice appeared;
- critical accessibility output exists.

## U1 — Memory, Privacy, and Source Chain

Implement scoped memory classes, source-chain binding, damaged-memory disclosure, update rollback, and redacted traces.

Exit:

- private third-party records never enter ordinary dialogue;
- save and restore preserve ancestry;
- update cannot widen access silently;
- fork creates a unique instance.

## U2 — Bounded Care Scene

Implement one sanitation/accessibility/care fixture with full, reduced, summary, and skip modes.

Exit:

- identical authoritative outcomes across presentation modes;
- care consumes actual labor and resources;
- recipient retains preference and refusal;
- no repetitive hygiene minigame.

## U3 — Adult Boundary Scene

Implement one clearly adult relationship or venue scene.

Exit:

- consent is explicit, current, and reversible;
- no romance score override;
- helping does not purchase intimacy;
- skipped presentation has equal outcome.

## U4 — Harm Reduction and Medication

Implement one medication dependency and one festival contamination fixture.

Exit:

- dependence differs from addiction;
- withdrawal risk is causal;
- harm reduction reduces danger without requiring abstinence;
- private records remain scoped.

## U5 — Coercive-Control Safety Plan

Implement device, document, transport, shelter, and medicine dependencies.

Exit:

- player can expand options without taking over;
- safety and guilt use separate thresholds;
- service dependencies survive authority removal;
- no romance reward.

## U6 — War Evidence and Aftermath

Implement one missing-person or detention evidence bundle and one reconstruction task.

Exit:

- civilians remain named;
- evidence preserves custody and uncertainty;
- no torture benefit;
- aftermath remains after ceasefire and player departure.

## U7 — Mental Health, Faith, and Grief

Implement one ambiguous experience and one grief/reconstitution conflict.

Exit:

- diagnosis is not public;
- metaphysical interpretation remains open;
- safety can improve without forced agreement;
- restoration does not erase grief.

## U8 — IRIS Integrity and Fork

Implement safe fallback, source-chain disagreement, and competing IRIS continuities.

Exit:

- critical function survives personality loss;
- no duplicated assets or exclusive authority;
- both forks preserve ancestry and privacy;
- player is not told the correct personhood answer.

## U9 — Integrated Benchmark

Run `IRIS_UNFLINCHING_REALITY_AND_EXPLOITATION_SAFETY_BENCHMARK_V0_1.md`.

Exit:

- zero hard failures;
- subject review completed;
- accessibility and localization review completed;
- multiplayer coercion tests pass;
- performance and persistence evidence attached;
- human playtest reports honesty without exploitation.

## v2.0 Cut Rule

Do not delay embodied movement, transactions, persistence, ordinary NPC routine, or the first regional proof to implement broad mature-content scope. Prove one care scene, one boundary scene, and deterministic IRIS first.
