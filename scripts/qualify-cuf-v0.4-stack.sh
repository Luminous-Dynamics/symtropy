...
#
# Local qualification gate for the stacked Causal Universe Fabric v0.1-v0.4
# tranches. Run from inside the repository's intended Nix development shell,
# or invoke as: nix develop --command bash scripts/qualify-cuf-v0.4-stack.sh
...
CUF v0.2-v0.4 qualification requires the full/private Luminous Dynamics
...
printf '\n== World authority + fidelity + residency ==\n'
...
printf '\nPASS: CUF v0.1-v0.4 local qualification gates\n'
