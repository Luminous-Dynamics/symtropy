...
#
# Local qualification gate for the stacked Causal Universe Fabric v0.1-v0.6.
...
CUF v0.2-v0.6 qualification requires the full/private Luminous Dynamics
...
printf '\n== World authority + evidence + Basin state identity ==\n'
...
printf '\nPASS: CUF v0.1-v0.6 local qualification gates\n'
