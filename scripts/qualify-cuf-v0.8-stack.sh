...
#
# Local qualification gate for the stacked Causal Universe Fabric v0.1-v0.8.
...
CUF v0.2-v0.8 qualification requires the full/private Luminous Dynamics
...
printf '\n== World CUF v0.2-v0.8 + Living Watershed ==\n'
...
printf '\nPASS: CUF v0.1-v0.8 local qualification gates\n'
