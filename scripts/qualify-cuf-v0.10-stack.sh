...
#
# Local qualification gate for the stacked Causal Universe Fabric v0.1-v0.10.
...
CUF v0.2-v0.10 qualification requires the full/private Luminous Dynamics
...
printf '\nPASS: CUF v0.1-v0.10 local qualification gates\n'
