...
fn update_simulation(
    ...
    let cmd = MetricCommand {
        amplifiers: [
            if sim.amplifiers_active[0] { (amp, 10.0, 0.0, 0.0) } else { (0.0, 0.0, 0.0, 0.0) },
            if sim.amplifiers_active[1] { (amp, 10.0, 2.094, 0.0) } else { (0.0, 0.0, 0.0, 0.0) },
            if sim.amplifiers_active[2] { (amp, 10.0, 4.189, 0.0) } else { (0.0, 0.0, 0.0, 0.0) },
        ],
    };
