...
impl AssistiveController {
    ...
    pub fn compute(&self, state: &ExoskeletonState, mode: AssistanceMode, state_metrics: ConsciousnessState) -> ExoskeletonCommand {
        ...
        let performance_factor = 1.0 - (state_metrics.fatigue * 0.5 + state_metrics.trauma * 0.3).clamp(0.0, 1.0);
