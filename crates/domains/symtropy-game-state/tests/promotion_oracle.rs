...
//! Authority-bearing v0.11r2 semantic-oracle pilot for `symtropy-game-state`.
//!
//! Child candidates are not authoritative over these bytes. The trusted
//! reusable workflow is read from this exact target-base generation and runs
//! this exact test against only the candidate's `src/lib.rs`.
