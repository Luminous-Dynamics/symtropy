...
fn main() {
    ...
    println!(
        "willingness,seed,alive,maintenance,well_regen,resonance_regen,ambient_regen,at_well_frac,seeking_frac,displacement,efficiency"
    );
    ...
    for (w, results) in &all {
        ...
        eprintln!(
            "  {w:.1}  {:5.1}  {:7.0}   {:7.0}   {:7.0}   {:7.0}   {:5.1}%  {:5.1}%   {:.2}   {:.3}",
