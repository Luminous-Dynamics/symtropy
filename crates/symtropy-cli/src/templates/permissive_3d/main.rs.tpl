//! `{{project_name}}` — Permissive Symtropy 3D scene.
//!
//! One swinging pendulum, PBR rendering, dev console toggleable on F1.
//! Generated from `symtropy new --template permissive-3d`.

use symtropy_core::prelude::*;
use symtropy_core::scene::{fixed_camera, SymtropyScenePlugin};
use symtropy_core::devconsole::SymtropyDevConsolePlugin;
use symtropy_core::physics::constraint::DistanceConstraint;
use symtropy_core::physics::RigidBody;
use symtropy_core::math::Sphere as PhysicsSphere;
use symtropy_core::bevy_physics::SymtropyPhysics;
use bevy::prelude::*;
...
fn setup(
    ...
    mut physics: ResMut<SymtropyPhysics<3, NoCouplingResource>>,
