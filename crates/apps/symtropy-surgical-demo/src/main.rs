...
//! Surgical-robot demo: Φ selects a shared `MotorSafetyLevel` tier; cautery
//! is a hard interlock.
//!
...
//!
//!   Φ > 0.6  → Green   (100% torque, cautery allowed)
//!   0.3–0.6  → Yellow  (40% torque, cautery BLOCKED)
//!   0.1–0.3  → Orange  (0% torque, cautery BLOCKED)
//!   < 0.1    → Red     (0% torque, cautery BLOCKED)
//!
//! `surgical_cautery_allowed()` is a HARD INTERLOCK: only the Green tier
//! permits energy delivery. This is the first demo in the series
