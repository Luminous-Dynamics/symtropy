...
fn three_worlds_milestones_form_verified_multi_parent_history() {
    ...
    let clause_disputed = history
        .append(
            ...
            None,
            None,
            vec![treaty_active, freight_arrived],
            Milestone {
                world: "Aster/Vesper",
    ...
    let external_request_admitted = history
        .append(
            271,
            "external-project-request-admitted",
            None,
            None,
            vec![clause_disputed.clone()],
            Milestone {
                world: "Vesper/Mycelix",
                assertion: "external governance becomes bounded evidence, not project mutation",
            },
        )
        .expect("append external request admission");
    ...
    let project_completed = history
        .append(
            ...
            None,
            vec![
                external_request_admitted,
                materialized_actor,
                authority_transferred,
            ],
            Milestone {
                world: "Vesper/Helion",
                assertion: "independent contribution requires explicit review before completion",
            },
        )
