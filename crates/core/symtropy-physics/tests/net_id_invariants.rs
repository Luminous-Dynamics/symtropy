...
fn assigning_another_bodys_netid_cannot_steal_the_mapping() {
    ...
    world
        .set_net_id(a, NetId(100))
        .expect("first NetId assignment");
    world
        .set_net_id(b, NetId(200))
...
fn assigning_same_netid_to_same_body_is_idempotent() {
    ...
    world
        .set_net_id(handle, NetId(42))
        .expect("initial NetId assignment");
    world
        .set_net_id(handle, NetId(42))
        .expect("same-owner reassignment is idempotent");
...
fn changing_to_free_netid_removes_exactly_the_old_mapping() {
    ...
    world
        .set_net_id(handle, NetId(1))
        .expect("initial NetId assignment");
    world
        .set_net_id(handle, NetId(2))
        .expect("free NetId reassignment");
