...
//! - `friction_applied_transition_2d` — stable 2D transition evidence bound to an Applied token
...
pub use friction_applied_transition_2d::{
    AppliedFrictionTransition2dError, measure_applied_friction_transition_2d_checked,
};
