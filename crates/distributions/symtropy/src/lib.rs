...
//! | `hdc-research` | Re-exports deterministic HDC primitives and physics episode memory. | no |
//!
//! ## Naming
//!
...
pub use symtropy_hdc_core as hdc;
#[cfg(feature = "hdc-research")]
pub use symtropy_hdc_physics as hdc_physics;
...
pub mod prelude {
    ...
    pub use symtropy_bevy_scene::{SymtropyScenePlugin, fixed_camera, fixed_light};
